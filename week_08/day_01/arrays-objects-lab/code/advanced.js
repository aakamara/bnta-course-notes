...
} else if (scotland.population > (england.population || wales.population || northernIrelandKeys.population)){
    console.log("Scotland had the greatest population");
} else {
    console.log("Scotland has the same population somewhere in the middle of the list countries");
}