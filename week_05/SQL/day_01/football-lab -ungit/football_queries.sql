...
SELECT name FROM public.divisions WHERE country='SCOTLAND' -- Change 
...
SELECT division_code, season FROM public.matches WHERE ftag = (SELECT MAX(ftag) FROM public.matches); -- Implementation?
